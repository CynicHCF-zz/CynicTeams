...
import rip.lazze.libraries.command.Type;
import rip.lazze.libraries.command.parameter.filter.NormalFilter;
...
//        }
        ...
        String rankPrefix = CC.translate(AquaCoreAPI.INSTANCE.getPlayerRank(sender.getUniqueId()).getPrefix());
