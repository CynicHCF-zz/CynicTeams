...
public class TeamCommand {
    ...
    public static void team(Player sender) {
        ...
        if (!HCF.getInstance().getServerHandler().isCustomHelp()) {
            sender.sendMessage(HCTEAMS_HELP);
            return;
        }

        String sectionColor = ChatColor.translateAlternateColorCodes('&', HCF.getInstance().getServerHandler().getHelpSectionColor());
        String entryColor = ChatColor.translateAlternateColorCodes('&', HCF.getInstance().getServerHandler().getHelpEntryColor());
        String infoColor = ChatColor.translateAlternateColorCodes('&', HCF.getInstance().getServerHandler().getHelpInfoColor());
