...
public class DisposibalSignListener implements Listener
{
	...
	public DisposibalSignListener(HCF plugin) {
        this.lines = new String[] { CC.translate(""), CC.translate("&c&lDisposibal"), CC.translate(""), CC.translate("") };
        this.error = new String[] { CC.translate("&7&m-----------"), CC.translate("&c&lDisposibal"), CC.translate("&7&m-----------"), CC.translate("&cError") };

	}
    public Inventory openMainInventory(Player player) {
        Inventory inv = Bukkit.createInventory((InventoryHolder)null, 36, CC.translate("&c&lDisposibal"));
    ...
    public void onSignPlace(SignChangeEvent event) {
        if (event.getLine(0).equals("[Disposital]")) {
