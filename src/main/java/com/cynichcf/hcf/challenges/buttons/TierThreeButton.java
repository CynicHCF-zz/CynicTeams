...
import com.cynichcf.hcf.challenges.menu.TierThreeMenu;
...
public class TierThreeButton extends Button {
    ...
    public String getName(Player player) {
        return CC.translate("&c&lTier 3 Challenges");
    }

    public List<String> getDescription(Player player) {
        return Arrays.asList(
                CC.translate("&7&m-------------------------------------"),
                CC.translate("&7&oHardest challenges to complete"),
                "",
                CC.translate(" &e24 hour cooldown"),
                CC.translate(" &eHard challenges to complete"),
