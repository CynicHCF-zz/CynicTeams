...
public class MaterialUtils {
    ...
    private static ImmutableSet<Integer> DOOR_BLOCKS = ImmutableSet.of(64, 71, 96, 167, 193, 194, 195, 196, 197);

    private static ImmutableSet<Integer> FULL_BLOCKS = ImmutableSet.of(
